                    ...
                    Row(
                        ...
                        Box(
                            ...
                            if (searchQuery.isEmpty()) {
                                Text(
                                    text = stringResource(R.string.secret_share_search_placeholder),
            ...
            if (suggestions.isNotEmpty()) {
                LazyColumn(
                    ...
                    itemsIndexed(
                        ...
                        val isAlreadyInList = existingMediaIds.contains(item.mediaId)
                        ...
                        ShowTimeMediaListCard(
                            ...
                            subtitle = {
                                ...
                                val meta = if (!item.releaseYear.isNullOrBlank()) {
