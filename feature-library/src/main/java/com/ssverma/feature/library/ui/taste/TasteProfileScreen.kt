...
private fun TasteFilterChipsRow(
    ...
    Row(
        ...
        val filters = listOf(
            DiaryFilterType.ALL to "✨ All",
            DiaryFilterType.MOVIES_ONLY to "🎬 Movies",
            DiaryFilterType.TV_ONLY to "📺 TV Shows",
            DiaryFilterType.REWATCHES_ONLY to "🔁 Rewatches",
            DiaryFilterType.FIVE_STARS_ONLY to "⭐ 5-Stars"
        )
