...
@HiltViewModel(assistedFactory = TvEpisodeDiscussionsViewModel.Factory::class)
class TvEpisodeDiscussionsViewModel @AssistedInject constructor(
    ...
    @Assisted("episodeTitle") private val episodeTitle: String?,
    ...
    val title: String? = episodeTitle ?: "S${seasonNumber} E${episodeNumber}"
